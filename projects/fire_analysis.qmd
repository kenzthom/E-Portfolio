...
The summer of 2017 was one of the most severe fire seasons in British Columbia, which included the Prouton Lakes fire near Williams Lake, BC. This project quantified burn severity and tracked post-fire vegetation recovery using multi-temporal Landsat 8 OLI imagery. In this analysis, a large volume of satellite imagery was processed through the development of custom functions and implemention of iterative workflows. The main objectives were to calculate burn severity and vegetation indices across the study area, allowing visualization and quantification of landscape level recovery patterns over multiple years.
...
```         
#(1)seperate pre-fire and post-fire 
...
#(3)reclassify using table provided 
m <- c(-0.2, 0.15, 0,
       0.15, 0.25, 1,
       0.25, 0.3, 2,
       0.3, 1, 3)
...
#(4)plot dnbr rast with PL fire extent on top
...
::::: columns
::: {.column width="40%"}
![](/images/ndvi_bord.png)
:::

::: {.column width="60%"}
**Image 1:** Yearly composite of NDVI averaged across July and August in the Prouton Lakes fire area. Pixels with unclear conditions (smoke/cloud) have been masked using Landsats QA Pixel layer.
:::
:::::
