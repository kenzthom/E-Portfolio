...
This analysis was done to support Municipal Transportation Asset Management reporting using ArcGIS Pro ModelBuilder and Python Scripting.
...
**Hierarchical Classification of Road Network:** Open Street Map Highways for North America symbology was applied to North Vancouver's road network, allowing hierarchial classification of roads using a hierarchical code for each OSM 'Highway' category:
...
| Corridor, cycleway, foot/pedestrian path, track, and construction | 1 |
| Other | 0 |
...
#layers
osm_roads <- suppressMessages(st_read("C:/MGEM/BCIT/Labs/GIST8138/Module3_ScriptTools/Data/nv_roads_osm_symbolized.shp"))

reclass_roads <- suppressMessages(st_read("C:/MGEM/BCIT/Labs/GIST8138/Module3_ScriptTools/Data/nv_roads_reclassified.shp"))

buffers <- suppressMessages(st_read("C:/MGEM/BCIT/Labs/GIST8138/Module3_ScriptTools/Data/major_roads_buffers.shp")) 
