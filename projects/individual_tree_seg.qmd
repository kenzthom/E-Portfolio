...
Individual tree segmentation is a fundamental component of modern forestry, significantly improving the efficiency of forest monitoring and management. By automating analysis at the single-tree scale, this method allows for the precise estimation of key structural parameters, such as biomass and carbon stocks, reducing the reliance on labor-intensive traditional fieldwork. Ultimately, these insights empower more informed and sustainable forest management. In this analysis, the lidR package was used to evaluate two primary segmentation methods on four different plots within the Malcolm Knapp Research Forest in British Columbia. Point cloud normalization and filtering was completed prior to segmentation using a point-cloud derived Digital Elevation Model (DEM).
