...
Individual tree segmentation is a cornerstone of modern forestry, transforming how we monitor and manage forest ecosystems. By enabling automated analysis at the single-tree level, this technique provides precise estimates of vital structural parameters (biomass and carbon stocks) that would otherwise require time and labor intensive fieldwork. Ultimately, these insights empower more informed and sustainable forest management. For this study, the lidR package was used to evaluate two primary segmentation methods on four different plots within the Malcolm Knapp Research Forest in British Columbia. Point cloud normalization and filtering was completed prior to segmentation using a point-cloud derived Digital Elevation Model (DEM).
