...
To translate these diverse datasets into a unified suitability model, I developed a custom workflow in R involving these key steps:
...
It was found that 76.5% (723,947.99 km²) of BC is restricted from solar farm development. Non-restricted land accounts for the remaining 23.55% (223,027.33 km²) of the province. Within this area, class 1 comprises 3.86% of the provincial land base, class 2 represents the largest share at 16.21%, and class 3 accounts for 3.25%. The highest suitability classes occupy only a very small portion of the province, with class 4 covering 0.21% and class 5 covering just 0.005%.
:::
